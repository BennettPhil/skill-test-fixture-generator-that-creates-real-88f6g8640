...
DEFAULT_TOPIC="A test fixture generator that creates realistic sample data for testing. Given a JSON schema or TypeScript interface, it produces an array of realistic test objects with plausible fake data."
DEFAULT_CONTEXT="Should handle nested objects, arrays, enums, and optional fields. Output should be deterministic given a seed value."
